...
<div class="card"> 
<a href="app-address-add.html" style ="width:120px;margin-left: auto;margin-top:10px;margin-right:10px"class="dt-button add-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" ><span><i class="bx bx-plus me-0 me-sm-2"></i><span class="d-none d-lg-inline-block">اضافة </span></span></a>

  <h5 class="card-header">العناويين</h5> 
    ...
    <table class="table">
      ...
      <tbody class="table-border-bottom-0">
        ...
        shark@gmail.com
          ...
          <td> 
            <a href="app-address-edit.html" href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i> </a>
