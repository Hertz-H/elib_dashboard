...
<head>
    ...
    <link rel="stylesheet" href="app/public/css/book_page.css">
    <link rel="stylesheet" href="app/public/css/slider_with_js.css">
...
<body>
    ...
    <main>
        <div class="container">
            <?php include('app/include/slider.php');?>
             </div>
        ...
        <div class="container">
            ...
            <div class="book_sec">
                <div class="img_container">
                    <img  class="imgs_opo" id="first_img_array" src="app/public/img/i_4.jpg" alt="">
                    <div class="img_icon_container">
                        <img  src="app/public/img/i_4.jpg" alt="">
                    </div>
                </div>
                <div class="img_info">
                    <h2>كن أنت (كتاب إلكتروني)</h2>
                    <a href=""> عرض المزيد  <i class="fas fa-angle-down"></i> </a> 
                    <div class="price">
                        12.99<span class="currency">ر.س</span>
                        <div>
                            شامل الضريبة
                        </div>
                    ...
                    <div class="product_info">
                        ...
                        <div>
                            <i class="svg_icon"><img src="app/public/img/star.svg" alt=""></i> 
                            <i class="svg_icon"><img src="app/public/img/star.svg" alt=""></i> 
                            <i class="svg_icon"><img src="app/public/img/star.svg" alt=""></i> 
                            <i class="svg_icon"><img src="app/public/img/star.svg" alt=""></i> 
                            <i class="svg_icon"><img src="app/public/img/star.svg" alt=""></i> 
                ...
                <div class="adding_to_basket_container">
                    <div class="upper_basket">
                        ...
                        <div class="features">
                            <div class="feat_items"><i class="svg_icon"><img src="app/public/img/lock.svg"></i>  تسوق أمن   <i class="svg_icon_2"><img src="app/public/img/info_blue.svg" alt=""></i></div>
                            <div class="feat_items"><i class="svg_icon"><img src="app/public/img/gar.svg"></i> أصلي ومضمون   <i class="svg_icon_2"><img src="app/public/img/info_blue.svg"></i></div>
                            <div class="feat_items">  <i class="svg_icon"> <img src="app/public/img/delivery.svg"></i> شحن سريع ومجاني  <i class="svg_icon_2"><img src="app/public/img/info_blue.svg"></i></div>
                        </div>
                        <hr>
                        <div class="actions">
                            <a href="" class="action_item"> <i class=" svg_icon"><img src="app/public/img/share.svg"></i>   مشاركة  </a>
                            <a href="" class="action_item"> <i class=" svg_icon"><img src="app/public/img/fav (1).svg"></i> المفضلة   </a>
                        
                            <a href="" class="action_item"> <i class=" svg_icon"><img src="app/public/img/compare.svg"></i>   مقارنة </a>
                        </div>
                    </div>
        ...
        <section class="similar_products_sec">
            <div class="container">
                ...
                <div class="similar_products_container">
                        <div class="sim_product_item">
                            ...
                            <div class="img_sim_prod_con">
                                <img src="app/public/img/i_2.jpg" alt="">
                            </div>
                    ...
                    <div class="sim_product_item">
                        ...
                        <div class="img_sim_prod_con">
                            <img src="app/public/img/i_5.jpg" alt="">
                        </div>
                        <div class="sim_pro_info">
                        <p>النسوية</p>
                        <div class="price">
                ...
                <div class="sim_product_item">
                    ...
                    <div class="img_sim_prod_con">
                        <img src="app/public/img/i_3.jpg" alt="">
                    </div>
                    <div class="sim_pro_info">
                    <p>النسوية</p>
                    <div class="price">
...
<script src="app/public/js/book_page_img_pop.js"> </script>
